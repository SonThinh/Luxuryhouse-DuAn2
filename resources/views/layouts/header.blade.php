            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->segment(1) === 'place' || request()->segment(1) === null) ? 'active' : '' }}"
                               href="{{(request()->segment(1) == 'place'|| request()->segment(1) === null) ? 'javascript:void(0)' : route('place')}} "><span>Địa điểm</span></a>
                        </li>
                        @if(Auth::check())
                            <li class="nav-item">
                                <a class="nav-link"
                                   href="{{(request()->segment(2) === 'dashboard') ? 'javascript:void(0)' : route('users.dashboard.showDashboard',[auth()->user()->id])}}">
                                    @php
