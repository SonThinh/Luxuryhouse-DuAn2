                ...
                <div class="form-body post-form">
                    <form action="{{route('admin.house.editTripType',[$trip->id])}}" class="form-horizontal " method="post">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tên dạng chuyến đi</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="name" value="{{$trip->name}}">
                                @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="key" value="{{$trip->key}}">
                                @if($errors->has('key'))
                                    <div class="alert alert-danger alert-dismissible">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <div class="btn-bot">
                            ...
                            <a href="{{route('admin.house.showViewTripType')}}" type="submit" class="btn btn-block btn-danger"
                               id="cancel">Hủy</a>
                        </div>
                    </form>
                </div>
