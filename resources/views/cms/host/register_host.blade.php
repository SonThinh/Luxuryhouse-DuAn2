...
@section('main')
    <div class="container">
        <div class="login-form m-5" id="login-form">
            ...
            @endif
            <form action="{{route('users.host',[$user->id])}}" method="post" class="mt-3" autocomplete="off"
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="id_card" placeholder="Chứng minh nhân dân">
                        ...
                        @endif
                        <input type="text" name="business_license" placeholder="Giấy phép kinh doanh (nếu có)">
                        <label>
                        ...
                        <input type="submit" value="Đăng ký host">
                    </div>
                </div>
            </form>
        </div>
