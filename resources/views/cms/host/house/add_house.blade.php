                ...
                <form action="#" method="post" class="mt-3" id="add_house"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="my-4">
                                <p>Mô tả phòng</p>
                                <input type="number" class="w-25 form-control" name="n_bed"
                                ...
                                @endif
                                <input type="number" class="w-25 form-control" name="n_bath"
                                ...
                                @endif
                                <input type="number" class="w-25 form-control" name="n_room"
                                ...
                                @endif
                                <input type="number" class="w-25 form-control" name="max_guest"
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="house_utilities[]"
                                                   value="{{$utility->symbol}}">{{$utility->symbol}}
                                        </label>
                                    </div>
                                @endforeach
                            ...
                            <div class="my-4">
                                <p>Bảng giá</p>
                                <input type="number" class="w-25 form-control" name="m_to_t"
                                ...
                                @endif
                                <input type="number" class="w-25 form-control" name="f_to_s"
                                ...
                                @endif
                                <input type="number" class="w-25 form-control" name="extra_guest"
                                ...
                                @endif
                                <input type="number" class="w-25 form-control" name="max_night"
                            ...
                            <input id="btn-dis" class=" btn btn-success" disabled type="submit" value="Thêm mới">
                            <input id="btn-agree" class=" btn btn-success d-none" type="submit" value="Thêm mới">
                        </div>
                    </div>
                </form>
            </div>
