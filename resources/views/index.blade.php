...
<head>
    ...
    <link rel="stylesheet" href="{{asset('../resources/assets/home/css/style.css')}}" type="text/css" media="all"/>
    <!-- Style-CSS -->
    ...
    <link rel="stylesheet" href="{{asset('../resources/assets/home/css/fontawesome-all.css')}}">
...
<script type="text/javascript" src="{{asset('../resources/assets/home/js/typeahead.js')}}"></script>
<script src="{{asset('../resources/assets/home/js/toggle-bt4.min.js')}}"></script>
<script src="{{asset('../resources/assets/home/js/popper.min.js')}}"></script>
